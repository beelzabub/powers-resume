    ...
    projects: [
      {
        ...
        outcome: 'Shipped in ~4 days · 201 commits · ~90 merge requests · 95 issues · 13.5K LOC app code + 18 SQL migrations',
        bullets: [
          ...
          'Architected a D1 (SQLite) schema across 18+ migrations, seeding a worldwide surf-spot atlas from OpenStreetMap and Wikidata bulk-import pipelines',
...
export const skillGroups = [
  {
    ...
    items: [
      ...
      { name: 'LLM Orchestration', desc: "Composing multi-step, tool-using AI workflows — chaining models, tools, and review gates to tackle large tasks like bulk data import, schema migration, and full-stack feature delivery that exceed a single prompt.", companies: ['AI-Augmented Engineering'], projects: ['Channel Surf TV', 'SAFe Portfolio Simulator'], link: 'https://www.anthropic.com/research/building-effective-agents' },
    ]
  },
  {
    title: 'Languages',
    items: [
      ...
      { name: 'TypeScript', desc: "Typed superset of JavaScript used across the Cloudflare Workers API and Astro frontend of Channel Surf TV — bringing compile-time safety and maintainability to AI-built full-stack code.", companies: ['AI-Augmented Engineering'], projects: ['Channel Surf TV'], link: 'https://www.typescriptlang.org' },
