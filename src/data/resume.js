...
export const experience = [
  {
    ...
    projects: [
      ...
      },
      {
        ...
        blurb: 'A ~54K-line Python platform that bootstraps and analyzes Scaled Agile (SAFe) portfolios on GitLab — WSJF, flow metrics, interactive dashboards, and auto-generated sprint-review decks — fully containerized for one-command deployment to AWS ECS, EKS, or S3/CloudFront via CDK.',
        ...
        outcome: 'Deployable to AWS ECS, EKS, or S3/CloudFront via CDK · ~54K LOC Python (app + tests + IaC) + a Vue 3 console · 754 commits · 194 merge requests',
        bullets: [
          'Directed AI agents to build a ~54,000-line Python SAFe-automation platform (plus a Vue 3 console) over ~3 months (754 commits, 194 merge requests)',
