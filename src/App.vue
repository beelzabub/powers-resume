...
const skillGroups = [
  ...
  },
  {
    title: 'Systems & Comms',
    items: [
      { name: 'Link 16', desc: "NATO primary tactical data link — a TDMA-based network for real-time exchange of voice, data, and surveillance between air, ground, and sea platforms. Core to the BACN gateway mission.", companies: ['Northrop Grumman (BACN)'], projects: ['BACN BIB', 'RF / Tactical Data Link Integration'], link: 'https://en.wikipedia.org/wiki/Link_16' },
      { name: 'CDL', desc: "Common Data Link — a family of wideband point-to-point data links for transmitting imagery and sensor data from airborne ISR platforms to ground stations. Integrated via BACN.", companies: ['Northrop Grumman (BACN)'], projects: ['RF / Tactical Data Link Integration'], link: 'https://en.wikipedia.org/wiki/Common_data_link' },
      { name: 'EPLRS', desc: "Enhanced Position Location Reporting System — a digital radio system providing position location, navigation, and data communications for ground forces. Bridged through BACN gateway.", companies: ['Northrop Grumman (BACN)'], projects: ['RF / Tactical Data Link Integration'], link: 'https://en.wikipedia.org/wiki/Enhanced_Position_Location_Reporting_System' },
      { name: 'VOIP', desc: "Voice over IP integration for BACN voice bridging subsystem, allowing ground forces and aircraft to communicate across incompatible radio systems via the airborne gateway.", companies: ['Northrop Grumman (BACN)'], projects: ['RF / Tactical Data Link Integration'], link: 'https://en.wikipedia.org/wiki/Voice_over_IP' },
      ...
      { name: 'BACN', desc: "Battlefield Airborne Communications Node — Northrop Grumman high-altitude airborne gateway with 200K+ combat flight hours and a $3.6B IDIQ contract. Jamie was a core developer for 9 years.", companies: ['Northrop Grumman (BACN)'], projects: ['BACN BIB', 'RF / Tactical Data Link Integration'], link: 'https://www.northropgrumman.com/what-we-do/mission-solutions/battlefield-airborne-communications-node-bacn' },
