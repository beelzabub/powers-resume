...
const experience = [
  ...
  },
  {
    ...
    projects: [
      ...
      {
        id: 'rf-links', name: 'BACN Tactical Data Link Work', customer: 'US Air Force / DoD Joint',
...
const skillGroups = [
  {
    title: 'Languages',
    items: [
      { name: 'Python', desc: "Primary scripting and backend language for DoD systems. Used for automation, microservices, data processing, and CI/CD scripting across GALT and BACN programs.", companies: ['GALT Aerospace', 'Northrop Grumman (BACN)'], projects: ['FINN Program', 'SkyTower II', 'BACN BIB', 'DevSecOps Org Build'], link: 'https://www.python.org' },
      { name: 'Java', desc: "Enterprise backend language used for web services, data processing, and cross-platform DoD applications including BACN and the Joint Effects Model.", companies: ['Northrop Grumman (BACN)', 'Northrop Grumman (JEM)'], projects: ['BACN BIB', 'Joint Effects Model'], link: 'https://dev.java' },
      ...
      { name: 'React', desc: "Component-based UI library used for the BACN situational awareness platform with Redux state management and CesiumJS 3D geospatial visualization.", companies: ['Northrop Grumman (BACN)'], projects: ['BACN BIB'], link: 'https://react.dev' },
      { name: 'Redux', desc: "Predictable state container used alongside React for managing complex real-time battlefield data in the BACN Information Broker application.", companies: ['Northrop Grumman (BACN)'], projects: ['BACN BIB'], link: 'https://redux.js.org' },
      ...
      { name: 'C++', desc: "Object-oriented systems language for CBRN modeling, Windows desktop apps, and the TychoMetrics platform with COM and OLE automation integration.", companies: ['Northrop Grumman (JEM)', 'Predicate Logic Inc.'], projects: ['Joint Effects Model', 'TychoMetrics Platform'], link: 'https://isocpp.org' },
      ...
      { name: 'Fortran', desc: "Scientific computing language used in the Joint Effects Model for CBRN physics simulation — still widely used in DoD modeling and simulation programs today.", companies: ['Northrop Grumman (JEM)'], projects: ['Joint Effects Model'], link: 'https://fortran-lang.org' },
      { name: 'Bash', desc: "Shell scripting for CI/CD automation, STIG compliance checks, system administration, and deployment orchestration across all Linux-based DoD environments.", companies: ['GALT Aerospace', 'Northrop Grumman (BACN)'], projects: ['DevSecOps Org Build', 'FINN Program'], link: 'https://www.gnu.org/software/bash/' },
    ]
  },
  {
    title: 'DevSecOps',
    items: [
      { name: 'Jenkins CI/CD', desc: "Automated build, test, and deployment pipelines. Built GALT entire Jenkins infrastructure from scratch including STIG-compliant deployment gates and approval workflows.", companies: ['GALT Aerospace', 'Northrop Grumman (BACN)'], projects: ['DevSecOps Org Build', 'FINN Program', 'BACN BIB'], link: 'https://www.jenkins.io' },
      ...
      { name: 'PyTest', desc: "Python testing framework used for unit, integration, and system testing of backend services across multiple DoD programs at GALT and Northrop Grumman.", companies: ['GALT Aerospace', 'Northrop Grumman (BACN)'], projects: ['FINN Program', 'BACN BIB', 'DevSecOps Org Build'], link: 'https://docs.pytest.org' },
      { name: 'Git / BitBucket', desc: "Distributed version control and code hosting. BitBucket used for DoD programs requiring on-premise or government-cloud repositories with audit trail compliance.", companies: ['GALT Aerospace', 'Northrop Grumman (BACN)'], projects: ['All programs'], link: 'https://bitbucket.org' },
    ]
  },
  {
    title: 'Systems & Comms',
    items: [
      { name: 'Link 16', desc: "NATO primary tactical data link — a TDMA-based network for real-time exchange of voice, data, and surveillance between air, ground, and sea platforms. Core to the BACN gateway mission.", companies: ['Northrop Grumman (BACN)'], projects: ['BACN BIB', 'BACN Tactical Data Link Work'], link: 'https://en.wikipedia.org/wiki/Link_16' },
      { name: 'CDL', desc: "Common Data Link — a family of wideband point-to-point data links for transmitting imagery and sensor data from airborne ISR platforms to ground stations. Integrated via BACN.", companies: ['Northrop Grumman (BACN)'], projects: ['BACN Tactical Data Link Work'], link: 'https://en.wikipedia.org/wiki/Common_data_link' },
      { name: 'EPLRS', desc: "Enhanced Position Location Reporting System — a digital radio system providing position location, navigation, and data communications for ground forces. Bridged through BACN gateway.", companies: ['Northrop Grumman (BACN)'], projects: ['BACN Tactical Data Link Work'], link: 'https://en.wikipedia.org/wiki/Enhanced_Position_Location_Reporting_System' },
      { name: 'VOIP', desc: "Voice over IP integration for BACN voice bridging subsystem, allowing ground forces and aircraft to communicate across incompatible radio systems via the airborne gateway.", companies: ['Northrop Grumman (BACN)'], projects: ['BACN Tactical Data Link Work'], link: 'https://en.wikipedia.org/wiki/Voice_over_IP' },
      ...
      { name: 'BACN', desc: "Battlefield Airborne Communications Node — Northrop Grumman high-altitude airborne gateway with 200K+ combat flight hours and a $3.6B IDIQ contract. Jamie was a core developer for 9 years.", companies: ['Northrop Grumman (BACN)'], projects: ['BACN BIB', 'BACN Tactical Data Link Work'], link: 'https://www.northropgrumman.com/what-we-do/mission-solutions/battlefield-airborne-communications-node-bacn' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Apache HTTP', desc: "Web server used for serving the BACN Information Broker web application and other DoD web interfaces on RedHat Linux in operational environments.", companies: ['Northrop Grumman (BACN)'], projects: ['BACN BIB'], link: 'https://httpd.apache.org' },
      { name: 'Node.js', desc: "JavaScript runtime used for backend services and build tooling in the BACN Information Broker alongside Webpack and Yarn for asset bundling.", companies: ['Northrop Grumman (BACN)'], projects: ['BACN BIB'], link: 'https://nodejs.org' },
      { name: 'ElasticSearch', desc: "Distributed search and analytics engine providing real-time tactical data querying for the BACN situational awareness platform across large operational datasets.", companies: ['Northrop Grumman (BACN)'], projects: ['BACN BIB'], link: 'https://www.elastic.co/elasticsearch' },
      ...
      { name: 'JIRA', desc: "Agile project management and issue tracking used to manage sprints, backlogs, and program-level tracking across GALT and BACN development teams.", companies: ['GALT Aerospace', 'Northrop Grumman (BACN)'], projects: ['DevSecOps Org Build', 'BACN BIB'], link: 'https://www.atlassian.com/software/jira' },
      { name: 'Webpack', desc: "JavaScript module bundler used to build and optimize the BACN Information Broker frontend application for production deployment on RedHat Linux.", companies: ['Northrop Grumman (BACN)'], projects: ['BACN BIB'], link: 'https://webpack.js.org' },
    ]
  },
]
