...
const skillGroups = [
  {
    title: 'Languages',
    items: [
      { name: 'Python', desc: "Primary scripting and backend language for DoD systems. Used for automation, microservices, data processing, and CI/CD scripting across GALT and BACN programs.", companies: ['GALT Aerospace', 'Northrop Grumman'], projects: ['FINN Program', 'SkyTower II', 'BACN BIB', 'DevSecOps Org Build'], link: 'https://www.python.org' },
      { name: 'Java', desc: "Enterprise backend language used for web services, data processing, and cross-platform DoD applications including BACN and the Joint Effects Model.", companies: ['Northrop Grumman', 'Northrop Grumman'], projects: ['BACN BIB', 'Joint Effects Model'], link: 'https://dev.java' },
      { name: 'JavaScript', desc: "Full-stack web language used across all DoD web UIs — spanning Backbone, React/Redux, and Vue3. Present on every program from JEM through GALT.", companies: ['GALT Aerospace', 'Northrop Grumman', 'Northrop Grumman'], projects: ['FINN Program', 'BACN BIB', 'Joint Effects Model'], link: 'https://developer.mozilla.org/en-US/docs/Web/JavaScript' },
      ...
      { name: 'React', desc: "Component-based UI library used for the BACN situational awareness platform with Redux state management and CesiumJS 3D geospatial visualization.", companies: ['Northrop Grumman'], projects: ['BACN BIB'], link: 'https://react.dev' },
      { name: 'Redux', desc: "Predictable state container used alongside React for managing complex real-time battlefield data in the BACN Information Broker application.", companies: ['Northrop Grumman'], projects: ['BACN BIB'], link: 'https://redux.js.org' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Fortify', desc: "Static application security testing (SAST) tool for identifying vulnerabilities in source code. Required for DoD software security compliance on the BACN program.", companies: ['Northrop Grumman'], projects: ['BACN BIB', 'Cyber Security Upgrades'], link: 'https://www.opentext.com/products/fortify-static-code-analyzer' },
      { name: 'DISA STIGs', desc: "Defense Information Systems Agency Security Technical Implementation Guides — mandatory security configurations for all DoD software. Automated STIG compliance was a core GALT capability enabling IATT accreditations.", companies: ['GALT Aerospace', 'Northrop Grumman'], projects: ['FINN Program', 'SkyTower II', 'BACN BIB'], link: 'https://public.cyber.mil/stigs/' },
      { name: 'Selenium', desc: "Browser automation framework for end-to-end testing of DoD web applications. Part of all automated test suites across GALT and BACN programs.", companies: ['GALT Aerospace', 'Northrop Grumman'], projects: ['DevSecOps Org Build', 'BACN BIB'], link: 'https://www.selenium.dev' },
      { name: 'PyTest', desc: "Python testing framework used for unit, integration, and system testing of backend services across multiple DoD programs at GALT and Northrop Grumman.", companies: ['GALT Aerospace', 'Northrop Grumman'], projects: ['FINN Program', 'BACN BIB', 'DevSecOps Org Build'], link: 'https://docs.pytest.org' },
  ...
  },
  {
    title: 'Systems & Comms',
    items: [
      { name: 'Link 16', desc: "NATO primary tactical data link — a TDMA-based network for real-time exchange of voice, data, and surveillance between air, ground, and sea platforms. Core to the BACN gateway mission.", companies: ['Northrop Grumman'], projects: ['BACN BIB', 'BACN'], link: 'https://en.wikipedia.org/wiki/Link_16' },
      ...
      { name: 'BACN', desc: "Battlefield Airborne Communications Node — Northrop Grumman high-altitude airborne gateway with 200K+ combat flight hours and a $3.6B IDIQ contract. Jamie was a core developer for 9 years.", companies: ['Northrop Grumman'], projects: ['BACN BIB', 'BACN'], link: 'https://www.northropgrumman.com/what-we-do/mission-solutions/battlefield-airborne-communications-node-bacn' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Apache HTTP', desc: "Web server used for serving the BACN Information Broker web application and other DoD web interfaces on RedHat Linux in operational environments.", companies: ['Northrop Grumman'], projects: ['BACN BIB'], link: 'https://httpd.apache.org' },
      { name: 'Node.js', desc: "JavaScript runtime used for backend services and build tooling in the BACN Information Broker alongside Webpack and Yarn for asset bundling.", companies: ['Northrop Grumman'], projects: ['BACN BIB'], link: 'https://nodejs.org' },
      { name: 'ElasticSearch', desc: "Distributed search and analytics engine providing real-time tactical data querying for the BACN situational awareness platform across large operational datasets.", companies: ['Northrop Grumman'], projects: ['BACN BIB'], link: 'https://www.elastic.co/elasticsearch' },
      ...
      { name: 'JIRA', desc: "Agile project management and issue tracking used to manage sprints, backlogs, and program-level tracking across GALT and BACN development teams.", companies: ['GALT Aerospace', 'Northrop Grumman'], projects: ['DevSecOps Org Build', 'BACN BIB'], link: 'https://www.atlassian.com/software/jira' },
      { name: 'Webpack', desc: "JavaScript module bundler used to build and optimize the BACN Information Broker frontend application for production deployment on RedHat Linux.", companies: ['Northrop Grumman'], projects: ['BACN BIB'], link: 'https://webpack.js.org' },
    ]
  },
]
