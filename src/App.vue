...
const skillGroups = [
  {
    ...
    items: [
      ...
      { name: 'Java', desc: "Enterprise backend language used for web services, data processing, and cross-platform DoD applications including BACN and the Joint Effects Model.", companies: ['Northrop Grumman', 'Northrop Grumman'], projects: ['BIB', 'Joint Effects Model'], link: 'https://dev.java' },
